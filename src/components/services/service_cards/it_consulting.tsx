...
import it_consulting from '@/app/img/services/it_consulting.jpg';
import { VscCommentDiscussion } from 'react-icons/vsc';


function ITConsultingCard() {
    ...
    return (
        <div className={`${cardStyle} ${styles.cardContainer}`}>
            <Image className='w-full h-[100%] object-cover ' loading='lazy' src={it_consulting} alt='Woman codifing' />
            <div className={`${cardDetails}`}>
                <span className={`${iconStyle}`}>
                    <VscCommentDiscussion />
                </span>
                <h3 className='lg:text-[1.5rem] text-[1.3rem] text-center mt-2 font-bold'>IT Consulting</h3>
