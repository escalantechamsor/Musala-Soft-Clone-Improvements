...
import business_analysis from '@/app/img/services/business_analysis.jpg';
...
function BusinessAnalysisCard() {
    ...
    return (
        <div className={`${cardStyle} ${styles.cardContainer}`}>
            <Image className='w-full h-[100%] object-cover object-right' loading='lazy' src={business_analysis} alt='Desktop with graphics' />
            <div className={`${cardDetails} `}>
                <span className={`${iconStyle}`}>
                    <IoAnalytics />
                </span>
                <h3 className='lg:text-[1.5rem] text-[1.3rem] text-center mt-2 font-bold'>Business
                    Analysis</h3>
