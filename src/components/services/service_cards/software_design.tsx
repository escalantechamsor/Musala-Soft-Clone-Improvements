...
import softdev from '@/app/img/services/soft_development.jpg';
import { GiUbisoftSun } from 'react-icons/gi';


function SoftwareDesignCard() {
    ...
    return (
        ...
        <Image className='w-full h-[100%] object-cover object-right' loading='lazy' src={softdev} alt='Woman codifing' />
        <div className={`${cardDetails}`}>
            <span className={`${iconStyle} pb-[2px] `}>
                <GiUbisoftSun/>
            </span>
            <h3 className='lg:text-[1.5rem] text-[1.2rem] text-center mt-2 font-bold'>Software Design & Development</h3>
            <Link href={'/software_design_development'}>
...
export default SoftwareDesignCard